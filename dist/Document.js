...
function (_Node) {
  ...
  function Document() {
    ...
    _this = _possibleConstructorReturn(this, (Document.__proto__ || Object.getPrototypeOf(Document)).call(this, _Node2.default.Type.DOCUMENT));
  ...
  _createClass(Document, [{
    ...
    value: function parseDirectives(start) {
      ...
      while (!Document.atDirectivesEnd(src, offset)) {
        ...
        switch (src[offset]) {
          ...
          case '%':
            {
              var directive = new _Node2.default(_Node2.default.Type.DIRECTIVE, null, {
                parent: this,
                src: src
              });
    ...
    value: function parse(context, start) {
      ...
      var src = context.src;
      var offset = this.parseDirectives(start);
    ...
    value: function toString() {
      ...
      if (contents.length > 0) {
        if (directives.length > 0 || contents[0].type === _Node2.default.Type.COMMENT) str += '---\n';
        str += contents.join('');
      }
