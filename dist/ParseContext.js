    ...
    value: function parseProps(offset) {
      ...
      while (ch === _Node.Char.ANCHOR || ch === _Node.Char.COMMENT || ch === _Node.Char.TAG || ch === '\n') {
        if (ch === '\n') {
          ...
          var noIndicatorAsIndent = parent instanceof _CollectionItem.default && parent.context.atLineStart;
      ...
      if (lineHasProps && _Node.default.atCollectionItem(src, offset)) offset -= 1;
