...
function () {
    ...
    Object.defineProperty(this, "parseNode", {
      ...
      value: function value(overlay, start) {
        ...
        switch (type) {
          ...
          default:
            node.error = new Error("Unknown node type: ".concat(JSON.stringify(type)));
  ...
  _createClass(ParseContext, [{
    ...
    value: function parseProps(offset) {
      ...
      while (ch === _Node.Prop.ANCHOR || ch === _Node.Prop.COMMENT || ch === _Node.Prop.TAG || ch === '\n') {
        if (ch === '\n') {
