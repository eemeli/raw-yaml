...
function (_Node) {
  ...
  function FlowCollection(type, props) {
    ...
    _this = _possibleConstructorReturn(this, (FlowCollection.__proto__ || Object.getPrototypeOf(FlowCollection)).call(this, type, props));
    _this.items = null;
    return _this;
  }
  ...
  _createClass(FlowCollection, [{
    ...
    value: function prevNodeIsJsonLike() {
      ...
      return !!node && (node.jsonLike || node.type === _Node2.default.Type.COMMENT && this.nodeIsJsonLike(idx - 1));
    }
    /**
